...
public class LoginSysteam {
    public static void main(String[] args) {
        ...
        if (pilihan == 1) { // Jika pengguna memilih Admin
            ...
            if (pilihan == 2) { // Jika pengguna memilih Mahasiswa
            ...
            admin2 anomali = new admin2('username);
            mahasiswaObj.login(); // Memanggil metode login() pada objek Mahasiswa untuk melakukan verifikasi login

        } else System.out.println("Pilihan tidak valid."); // Pesan error jika input tidak sesuai
