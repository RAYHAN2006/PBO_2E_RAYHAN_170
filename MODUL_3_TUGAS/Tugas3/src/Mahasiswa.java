...
class Mahasiswa extends User {
    ...
    public void login() {
        ...
        if (getNama().equalsIgnoreCase("Maulana Rayhan Zulkarnaen") && getNim().equals("202410370110170")) { // Menggunakan equalsIgnoreCase() agar perbandingan nama tidak case-sensitive
