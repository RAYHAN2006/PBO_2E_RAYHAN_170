...
public class Main {
    public static void main(String[] args) {
        ...
        RekeningBank rekening1 = new RekeningBank("202410370110170", "Maulana Rayhan Zulkarnaen", 600000);
        RekeningBank rekening2 = new RekeningBank("202410370110189", "Muhammad Syakhish Al Hanif", 800000);
